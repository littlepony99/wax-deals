...
public class JdbcOfferDao implements OfferDao {
    ...
    private static final String UPSERT_UNIQUE_VINYLS = "INSERT INTO unique_vinyls(id, release, artist, full_name, link_to_image, has_offers) VALUES(?, ?, ?, ?, ?, ?)" +
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            try (ResultSet resultSet = findVinylByIdStatement.executeQuery()) {
                ...
                while (resultSet.next()) {
                    ...
                    Offer offer = ROW_MAPPER.mapRow(resultSet, 1);
                    offers.add(offer);
                }
                if (isResultSetEmpty) {
