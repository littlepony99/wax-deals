...
class OneVinylOffersServiceImplTest {
    ...
    @Test
    @DisplayName("Checks whether vinyl.hasOffers flag is true when there are offers")
    void givenVinylListWithOffers_whenHasOffersSetToTrue_thenCorrect() {
        //prepare
    ...
    @Test
    @DisplayName("Checks whether vinyl.hasOffers flag is false when there is no any offer for the vinyl")
